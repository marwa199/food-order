                    ...
                    while($row=mysqli_fetch_assoc($res)){
                        ...
                        <div class="box-3 float-container">
                            ...
                            if($image_name==""){
                                ...
                                ?>
                            <img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="<?php echo $title; ?>" height="400px" class="img-responsive img-curve">
                                <?php
                            }
                            ?>
        ...
        <div class="container">
            ...
            <?php
                ...
                <?php
                    ...
                    //food not available
                    echo "<div class='error'>No Food Available To display</div>";
                }
